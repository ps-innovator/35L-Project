const FriendCardView = ({ header, onClick, shortDescr1, shortDescr2, shortDescr3, shortDescr4, shortDescr5, shortDescr6, longDescr, imgsrc, imgalt, highlight, emphasize, children }) => {
  ...
  return (
      <div className={`w-64 h-64 mx-auto ${finalBg} rounded-xl shadow-md overflow-hidden m-8 ${hoverColor}`} onClick={onClick}>
        <div className="flex flex-col items-center justify-between h-full text-center">
          ...
          <div className="p-4 flex flex-col items-center justify-center">
            <p className="block text-lg leading-tight font-medium text-black dark:text-zinc-400">
              <>
                {shortDescr1} <br />
                {shortDescr2} <br />
                {shortDescr3} <br />
