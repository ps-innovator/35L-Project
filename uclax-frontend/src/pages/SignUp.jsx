    ...
    return (
        ...
        Create An Account
          ...
          <div class="flex mb-6 items-center justify-center">
            <button className="block text-white p-4 rounded-lg bg-indigo-500 dark:bg-slate-500 hover:bg-indigo-600 dark:hover:bg-slate-600 active:bg-indigo-900 dark:active:bg-slate-900" style={{fontSize: 25, fontWeight: 200}}> Sign in with UCLA SSO  </button>
          </div>
          ...
          <div class="flex mb-6 items-center justify-center">
            <button className="block text-white p-4 rounded-lg bg-indigo-500 dark:bg-slate-500 hover:bg-indigo-600 dark:hover:bg-slate-600 active:bg-indigo-900 dark:active:bg-slate-900" style={{fontSize: 25, fontWeight: 200}}> Sign up </button>
          </div>
        </div>
    )
};
