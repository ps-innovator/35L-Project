    ...
    <div>
      ...
      <div className="flex mb-6 items-center justify-center">
        <button
          ...
          className="block text-white p-4 rounded-lg bg-indigo-500 dark:bg-slate-500 hover:bg-indigo-600 dark:hover:bg-slate-600 active:bg-indigo-900 dark:active:bg-slate-900"
